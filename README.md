...
Diseñé y ejecuté un análisis comprensivo de calidad para dos componentes críticos de una aplicación de movilidad: el sistema de registro de licencias de conducir y el algoritmo de cálculo de tiempo y costo de viajes. El proyecto implementó técnicas avanzadas de diseño de pruebas que permitieron identificar requisitos ambiguos y validar la lógica de negocio fundamental.
